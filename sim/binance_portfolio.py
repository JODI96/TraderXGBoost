...
class BinancePortfolio:
    ...
    def open_trade(
        ...
        try:
            ...
            print(f"  SL placed  stop={sl_price:.2f}")
            ...
            try:
                ...
                print(f"  TP placed  stop={tp_price:.2f}")
            except Exception as tp_exc:
                print(f"  TP FAILED ({type(tp_exc).__name__}): {tp_exc}")
    ...
    def check_exits(self, high: float, low: float) -> tuple[Optional[str], float]:
        ...
        """
        if self.position is None or not self._exchange_closed:
            return None, 0.0
